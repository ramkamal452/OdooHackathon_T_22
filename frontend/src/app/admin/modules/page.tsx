...
import { Clock, Edit, FileEdit, Filter, GraduationCap, Layers, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <StatsCard label="Total Courses" value={statsLoading ? '—' : stats.total} icon={<Layers className="h-5 w-5" />} />
        ...
        <Card className="border-dashed">
          <CardContent className="flex flex-wrap gap-4 pt-6">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={level || LEVEL_ANY}
                onValueChange={(v) => setLevel(v == null || v === LEVEL_ANY ? '' : v)}
              >
                <SelectTrigger className="w-[200px]">
                  <SelectValue placeholder="Any" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value={LEVEL_ANY}>Any</SelectItem>
        ...
        <form onSubmit={handleCreateCourse} className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Select
                value={courseCategoryId ? String(courseCategoryId) : CATEGORY_NONE}
                onValueChange={(v) => setCourseCategoryId(v == null || v === CATEGORY_NONE ? '' : v)}
      ...
      >
        ...
        <div className="mt-6 flex justify-end gap-3">
          ...
          <Button variant="destructive" onClick={() => deleteConfirm && handleDeleteCourse(deleteConfirm)}>
            Delete
          </Button>
        </div>
      </Modal>
